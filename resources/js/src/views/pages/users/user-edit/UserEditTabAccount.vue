  ...
  <div id="user-edit-tab-info">
    ...
    <div class="vx-row">
      <div class="vx-col md:w-1/2 w-full">
        ...
        <vs-input class="w-full mt-4" label="Mobile" v-model="data.phone" v-validate="{regex: '^\\+?([0-9]+)$' }" name="phone" />
      ...
      <div class="vx-col md:w-1/2 w-full">
        ...
        <vs-input class="w-full mt-4" label="Adress" v-model="data.address" v-validate="'alpha_spaces'" name="address" />
